  ...
  return (
    <div className="pt-32 pb-20 space-y-24">
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-emerald-900 rounded-[3rem] p-12 md:p-20 relative overflow-hidden flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="relative z-10 lg:w-3/5 space-y-8">
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-white leading-tight">
              Expert Visa Services for <span className="text-gold-500">Sacred Journeys</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              <button className="px-8 py-4 bg-gold-500 text-emerald-950 rounded-full font-bold hover:bg-gold-600 transition-all shadow-xl shadow-gold-500/20">
                Apply for Visa Now
              </button>
          ...
          <div className="relative z-10 lg:w-2/5">
            <div className="bg-white/10 backdrop-blur-xl p-8 rounded-3xl border border-white/20 space-y-6">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-2xl bg-gold-500 flex items-center justify-center text-emerald-950">
                  <ShieldCheck size={28} />
                </div>
                <div>
                  <div className="text-white font-bold">99.8% Success Rate</div>
                  <div className="text-white/60 text-xs uppercase tracking-widest">Verified Approval</div>
                </div>
              </div>
              <div className="space-y-4">
                {['Umrah Visa', 'Haj Visa', 'Tourist Visa', 'Business Visa'].map((v, i) => (
                  <div key={i} className="flex items-center justify-between text-white/80 text-sm py-2 border-b border-white/10">
                    <span>{v}</span>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 space-y-4">
          <h2 className="text-4xl font-bold text-slate-900">Our Step-by-Step Process</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
          ...
          {steps.map((step, idx) => (
            <div key={idx} className="relative z-10 bg-white p-8 rounded-3xl border border-slate-100 shadow-sm hover:shadow-md transition-all text-center space-y-4">
              <div className="w-12 h-12 rounded-full bg-emerald-600 text-white flex items-center justify-center font-bold text-xl mx-auto mb-4 border-4 border-white shadow-lg">
                {idx + 1}
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div className="space-y-8">
              <h2 className="text-4xl font-bold text-slate-900">Required Documents Checklist</h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={idx} className="flex items-center gap-3 p-4 bg-white rounded-2xl border border-slate-200">
            ...
            <div className="bg-white p-8 md:p-12 rounded-[2.5rem] shadow-xl border border-slate-100 space-y-8">
              <h3 className="text-2xl font-bold text-slate-900">Apply for Visa</h3>
              <form className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <input type="text" className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl outline-none" placeholder="Full Name" />
                  <input type="email" className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl outline-none" placeholder="Email Address" />
                </div>
                ...
                <textarea className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl outline-none h-32" placeholder="Message (Optional)"></textarea>
